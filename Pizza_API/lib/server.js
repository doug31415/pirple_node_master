...
// variables
const HTTP_PORT = _config.httpPort;
const HTTPS_PORT = _config.httpsPort;
const ENV_NAME = _config.name;
...
server.httpsServerOptions = {
    key: fs.readFileSync(path.join(__dirname, '/../../API/https/key.pem')),
    certificate: fs.readFileSync(path.join(__dirname, '/../../API/https/cert.pem')),
}
